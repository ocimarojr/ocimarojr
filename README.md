...
- 🔭 **Foco:** Projetos de portfólio do curso **CS50 de Harvard**.
...
- 🔭 **Current Focus:** Portfolio projects from **Harvard's CS50** course.
- 🌱 **Learning:** C, Python, SQL, and IT Support.
- 🎓 **Education:** Undergraduate student in Systems Analysis and Development (UVA).
- 💼 **Goal:** Opportunities as an IT Support Analyst / IT Technician.
- 🌍 **Background:** I have international experience living in the UK, which helped me develop resilience and adaptability.
...
- 🔭 **Focus attuale:** Progetti del corso **CS50 di Harvard**.
- 🌱 **Imparando:** C, Python, SQL e Supporto IT.
- 🎓 **Formazione:** Studente di Analisi e Sviluppo di Sistemi (UVA).
- 💼 **Obiettivo:** Opportunità come Analista di Supporto / Tecnico IT.
- 🌍 **Origini:** Ho vissuto nel Regno Unito e sono un appassionato della cultura italiana e delle mie origini.
